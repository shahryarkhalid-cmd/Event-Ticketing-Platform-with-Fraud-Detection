  ...
  function showEmailSentPopup() {
    ...
    overlay.innerHTML =
      '<div style="background:#fff;border-radius:16px;padding:28px 24px;max-width:340px;width:90%;text-align:center;box-shadow:0 20px 50px rgba(0,0,0,0.3);">' +
        '<p style="margin:0 0 8px;font-weight:600;color:#001F54;font-size:16px;">Enter Code</p>' +
        '<p style="margin:0 0 20px;color:#555;font-size:14px;">Enter any code to verif yourself </p>' +
