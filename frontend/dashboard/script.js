...
(() => {
  ...
  async function handleEventSubmit(e, status) {
    ...
    try {
      ...
      let friendly = "Couldn't save this event — please check your connection and try again.";
      if (msg.includes("403")) {
        friendly = "Your account doesn't have organizer permissions, so this event couldn't be published. Please make sure you're logged in with an organizer account.";
      } else if (msg.includes("401")) {
        friendly = "Your session has expired — please log in again.";
      } else if (msg.includes("422")) {
        friendly = "Some event details are missing or invalid — please check the form and try again.";
      }
